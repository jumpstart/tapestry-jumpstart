...
import jumpstart.business.domain.datestuff.DateStuffTest;
...
@SuiteClasses({ WorkoutServiceTest.class, CannotDeleteIsNotEmptyExceptionTest.class,
		...
		GenericBusinessExceptionTest.class, OptimisticLockExceptionTest.class, ReferenceNotMutableExceptionTest.class,
		ReferencesWrongSubsetExceptionTest.class, ValueRequiredExceptionTest.class, DateStuffTest.class,
