...
public class SecurityFinderService extends BaseService implements ISecurityFinderServiceLocal,
		ISecurityFinderServiceRemote {
	...
	public User findUserByLoginId(String loginId) throws DoesNotExistException {
		...
		try {
			Query q = em.createQuery("select u from User u where u.loginId = :loginId");
	...
	public List<User> findUsersShallowish() {
		...
		Query q = em.createQuery("select u from User u order by u.loginId");
	...
	public List<User> findUsersShallowish(UserSearchFields search, SearchOptions options) {
		...
		Query q = builder.createQuery(em, options, "u");
	...
	public List<Role> findRolesShallowish(RoleSearchFields search, SearchOptions options) {
		...
		Query q = builder.createQuery(em, options, "r");
	...
	public List<UserRole> findUserRolesShallowish() {
		...
		List<UserRole> l = q.getResultList();
