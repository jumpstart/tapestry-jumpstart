...
public class ClasspathURLConverterJBoss7 implements ClasspathURLConverter {
	private static Logger logger = LoggerFactory.getLogger(ClasspathURLConverterJBoss7.class);
		...
		if (url != null && url.getProtocol().startsWith("vfs")) {
			...
			try {
				...
				if (urlString.contains(".jar")) {
					...
					// An example URL: "vfs:/devel/jboss-as-7.1.1.Final/standalone/deployments/jumpstart.ear/jumpstart.war/WEB-INF/lib/tapestry-core-5.3.4.jar/org/apache/tapestry5/corelib/components/"
